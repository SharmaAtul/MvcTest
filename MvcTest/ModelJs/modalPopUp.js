angular.module('app').controllerProvider.register('modalPopUp', ['$scope', '$modalInstance', '$modal', '$http', '$document', 'items',
    function ($scope, $modalInstance, $modal, $http, $document, items) {
